...
COLOPHON = """  <div class="colophon">
    ...
    <p class="credit">Cover image generated with GPT (OpenAI). The text was
    written in dialogue with Claude (Anthropic) &mdash; see the
    <a href="authorship-note.html">authorship note</a>.</p>
    <div class="actions">
